...
/* 	strides_pt = (uiArray *)sstrides_pt;//malloc(sizeof(uiArray)+sizeof(unsigned int)*ndims); */
/* 	visited_pt = (uiArray *)svisited_pt; //malloc(sizeof(uiArray) + sizeof(unsigned int)*nel); */
/* 	joins_pt = (uiArray*)sjoins_pt;//malloc(sizeof(uiArray) + sizeof(unsigned int)*nel); */
...
/* 		acc_pt = (ulliArray *)sacc_pt;//malloc(sizeof(ulliArray) + sizeof(acc_t)*nel) ; */
/* 		ell_pt = (ulliArray *)sell_pt;//malloc(sizeof(ulliArray) + sizeof(acc_t)*gdl*nmer) ; */
