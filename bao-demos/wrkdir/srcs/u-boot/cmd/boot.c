...
static int do_go(struct cmd_tbl *cmdtp, int flag, int argc,
                 char *const argv[]) {
  ulong addr, rc;
  int rcode = 0;
  ...
  printf("## do_go ## Starting application at 0x%08lX ...\n", addr);
...
U_BOOT_CMD(reset, 2, 0, do_reset, "Perform RESET of the CPU",
