cmd_tools/lib/aes/aes-decrypt.o := cc -Wp,-MD,tools/lib/aes/.aes-decrypt.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer   -std=gnu11   -DCONFIG_FIT_SIGNATURE -DCONFIG_FIT_SIGNATURE_MAX_SIZE=0xffffffff -DCONFIG_FIT_CIPHER -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/lib/aes/aes-decrypt.o tools/lib/aes/aes-decrypt.c

source_tools/lib/aes/aes-decrypt.o := tools/lib/aes/aes-decrypt.c

deps_tools/lib/aes/aes-decrypt.o := \
...
tools/lib/aes/aes-decrypt.o: $(deps_tools/lib/aes/aes-decrypt.o)
