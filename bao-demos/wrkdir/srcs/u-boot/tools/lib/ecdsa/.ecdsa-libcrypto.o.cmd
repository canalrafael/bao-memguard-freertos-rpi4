cmd_tools/lib/ecdsa/ecdsa-libcrypto.o := cc -Wp,-MD,tools/lib/ecdsa/.ecdsa-libcrypto.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer   -std=gnu11   -DCONFIG_FIT_SIGNATURE -DCONFIG_FIT_SIGNATURE_MAX_SIZE=0xffffffff -DCONFIG_FIT_CIPHER -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/lib/ecdsa/ecdsa-libcrypto.o tools/lib/ecdsa/ecdsa-libcrypto.c

source_tools/lib/ecdsa/ecdsa-libcrypto.o := tools/lib/ecdsa/ecdsa-libcrypto.c

deps_tools/lib/ecdsa/ecdsa-libcrypto.o := \
...
tools/lib/ecdsa/ecdsa-libcrypto.o: $(deps_tools/lib/ecdsa/ecdsa-libcrypto.o)
