cmd_tools/lib/hash-checksum.o := cc -Wp,-MD,tools/lib/.hash-checksum.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer   -std=gnu11   -DCONFIG_FIT_SIGNATURE -DCONFIG_FIT_SIGNATURE_MAX_SIZE=0xffffffff -DCONFIG_FIT_CIPHER -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/lib/hash-checksum.o tools/lib/hash-checksum.c

source_tools/lib/hash-checksum.o := tools/lib/hash-checksum.c

deps_tools/lib/hash-checksum.o := \
...
tools/lib/hash-checksum.o: $(deps_tools/lib/hash-checksum.o)
